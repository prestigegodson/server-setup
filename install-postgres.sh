...
sudo -u postgres psql -d postgres -c "CREATE DATABASE IF NOT EXISTS $PROD_DB_NAME"
sudo -u postgres psql -d postgres -c "CREATE DATABASE IF NOT EXISTS $DEV_DB_NAME" 
sudo -u postgres psql -d postgres -c "CREATE ROLE IF NOT EXISTS $DB_USER_NAME LOGIN" 
